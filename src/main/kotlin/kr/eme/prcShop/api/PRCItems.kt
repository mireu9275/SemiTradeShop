...
object PRCItems {
    ...
    /** 양배추 (★★★) */
    val CABBAGE_G3   = item("§f양배추", Material.BLACK_DYE, 22, "§f수확일 4일", eatable = true)
    /** 오이 (★★★) */
    ...
    /** 옥수수 (★★★) */
    val CORN_G3      = item("§f옥수수", Material.BLACK_DYE, 26, "§f수확일 4일", eatable = true)
    /** 밀 (★★★) */
    val WHEAT_G3     = item("§f밀", Material.BLACK_DYE, 27, "§f수확일 5일", eatable = true)
    /** 크랜베리 (★★★) */
    ...
    /** 호박 (★★★) */
    val PUMPKIN_G3   = item("§f호박", Material.BLACK_DYE, 30, "§f수확일 5일", eatable = true)
...
//    val UNKNOWN_FLESH = item(material = Material.ROTTEN_FLESH, customModelData = null)
    ...
    /** 출입 모듈 */
    val GATE_MODULE            = item("§f출입 모듈", Material.SADDLE, 9, "§7모듈 내부의 압력을 조절해 외부 출입이 가능하게 하는 모듈")
