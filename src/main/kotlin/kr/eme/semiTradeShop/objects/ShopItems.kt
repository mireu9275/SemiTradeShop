...
object ShopItems {
    ...
    init {
        // 광물 상점 (Page 1)
        addItem("MineralShop", ShopItem("§f마그네슘", 25, 15, "", Material.RED_DYE, 1, 9, 1))
        addItem("MineralShop", ShopItem("§f알루미늄", 10, 5, "", Material.RED_DYE, 1, 10, 2))
        addItem("MineralShop", ShopItem("§f철", 100, 50, "", Material.RED_DYE, 1, 11, 3))
        addItem("MineralShop", ShopItem("§f구리", 100, 60, "", Material.RED_DYE, 1, 12, 4))
        addItem("MineralShop", ShopItem("§f리튬", 50, 30, "", Material.RED_DYE, 1, 13, 5))
        addItem("MineralShop", ShopItem("§f금", 200, 100, "", Material.RED_DYE, 1, 18, 6))
        addItem("MineralShop", ShopItem("§f백금", 30, 20, "", Material.RED_DYE, 1, 19, 7))
        addItem("MineralShop", ShopItem("§f니켈", 15, 10, "", Material.RED_DYE, 1, 20, 8))
        addItem("MineralShop", ShopItem("§f티타늄", 300, 150, "", Material.RED_DYE, 1, 21, 9))


        // 광물 상점 (Page 2)
        addItem("MineralShop", ShopItem("§f마그네슘 파우더", 25, 15, "", Material.RED_DYE, 2, 9, 10))
        addItem("MineralShop", ShopItem("§f알루미늄 파우더", 20, 10, "", Material.RED_DYE, 2, 10, 11))
        addItem("MineralShop", ShopItem("§f철 파우더", 30, 15, "", Material.RED_DYE, 2, 11, 12))
        addItem("MineralShop", ShopItem("§f구리 파우더", 50, 25, "", Material.RED_DYE, 2, 12, 13))
        addItem("MineralShop", ShopItem("§f리튬 파우더", 15, 10, "", Material.RED_DYE, 2, 13, 14))
        addItem("MineralShop", ShopItem("§f금 파우더", 200, 100, "", Material.RED_DYE, 2, 18, 15))
        addItem("MineralShop", ShopItem("§f백금 파우더", 30, 20, "", Material.RED_DYE, 2, 19, 16))
        addItem("MineralShop", ShopItem("§f니켈 파우더", 50, 25, "", Material.RED_DYE, 2, 20, 17))
        addItem("MineralShop", ShopItem("§f티타늄 파우더", 300, 150, "", Material.RED_DYE, 2, 21, 18))


        // 광물 상점 (Page 3)
        addItem("MineralShop", ShopItem("§f마그네슘 주괴", 25, 15, "", Material.RED_DYE, 2, 9, 19))
        addItem("MineralShop", ShopItem("§f알루미늄 주괴", 20, 10, "", Material.RED_DYE, 2, 10, 20))
        addItem("MineralShop", ShopItem("§f철 주괴", 30, 15, "", Material.RED_DYE, 2, 11, 21))
        addItem("MineralShop", ShopItem("§f구리 주괴", 50, 25, "", Material.RED_DYE, 2, 12, 22))
        addItem("MineralShop", ShopItem("§f리튬 주괴", 15, 10, "", Material.RED_DYE, 2, 13, 23))
        addItem("MineralShop", ShopItem("§f금 주괴", 200, 100, "", Material.RED_DYE, 2, 18, 24))
        addItem("MineralShop", ShopItem("§f백금 주괴", 30, 20, "", Material.RED_DYE, 2, 19, 25))
        addItem("MineralShop", ShopItem("§f니켈 주괴", 50, 25, "", Material.RED_DYE, 2, 20, 26))
        addItem("MineralShop", ShopItem("§f티타늄 주괴", 300, 150, "", Material.RED_DYE, 2, 21, 27))
        addItem("MineralShop", ShopItem("§f합금 주괴", 500, 250, "§f알루미늄 + 구리", Material.RED_DYE, 2, 22, 28))
        addItem("MineralShop", ShopItem("§f합금 주괴", 400, 200, "§f알루미늄 + 마그네슘", Material.RED_DYE, 2, 27, 29))
        addItem("MineralShop", ShopItem("§f합금 주괴", 350, 175, "§f알루미늄 + 리튬", Material.RED_DYE, 2, 28, 30))
        addItem("MineralShop", ShopItem("§f합금 주괴", 450, 225, "§f구리 + 금", Material.RED_DYE, 2, 29, 31))
        addItem("MineralShop", ShopItem("§f합금 주괴", 600, 300, "§f니켈 + 철", Material.RED_DYE, 2, 30, 32))
        addItem("MineralShop", ShopItem("§f합금 주괴", 800, 400, "§f티타늄 + 백금 + 금", Material.RED_DYE, 2, 31, 33))
        ...
        // 기타 상점 (Page 4)
        addItem("OtherShop", ShopItem("§f마그네슘 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 9, 23))
        addItem("OtherShop", ShopItem("§f알루미늄 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 10, 24))
        addItem("OtherShop", ShopItem("§f철 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 11, 25))
        addItem("OtherShop", ShopItem("§f구리 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 12, 26))
        addItem("OtherShop", ShopItem("§f리튬 니켈 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 13, 27))
        addItem("OtherShop", ShopItem("§f금 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 18, 28))
        addItem("OtherShop", ShopItem("§f백금 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 19, 29))
        addItem("OtherShop", ShopItem("§f니켈 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 20, 30))
        addItem("OtherShop", ShopItem("§f티타늄 주괴 레시피", 10, 5, "§f", Material.SADDLE, 4, 21, 31))
        addItem("OtherShop", ShopItem("§f합금 주괴 레시피", 10, 5, "§f알루미늄 + 마그네슘", Material.SADDLE, 4, 22, 32))
        addItem("OtherShop", ShopItem("§f합금 주괴 레시피", 10, 5, "§f알루미늄 + 구리", Material.SADDLE, 4, 27, 33))
